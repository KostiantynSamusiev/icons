...
?>
		...
		<div class="iconography__btn btn-blck">
			<a href="<?php echo get_the_permalink(pll_get_post(get_page_by_path('iconography')->ID)); ?>"><?php echo esc_attr(pll__('Button title')) ?></a>
		</div>
	</div>
...
?>
		...
		<a href="<?php echo get_the_permalink(pll_get_post(get_page_by_path('schools')->ID)); ?>"><?php echo esc_attr(pll__('Button title')) ?></a>
		</div>
	</div>
...
?>
		...
		<div class="iconography__btn btn-wht">
		<a href="<?php echo get_the_permalink(pll_get_post(get_page_by_path('masters')->ID)); ?>"><?php echo esc_attr(pll__('Button title')) ?></a>
		</div>
	</div>
...
?>
				...
				<a href="<?php echo get_the_permalink(pll_get_post(get_page_by_path('articles')->ID)); ?>"><?php echo esc_attr(pll__('Button title')) ?></a>
...
?>
		...
		<div class="iconography__btn btn-blck">
		<a href="<?php echo get_the_permalink(pll_get_post(get_page_by_path('books')->ID)); ?>"><?php echo esc_attr(pll__('Button title')) ?></a>
		</div>
	</div>
